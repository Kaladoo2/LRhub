...
if size_gb < 1 then
    print("\27[1;33m!\27[0m Size cannot be smaller than 1 GB")
    os.exit(1)
end
...
if free_bytes < target_size then
    print(string.format("\27[1;31m!\27[0m Not enough free space! Required: %.2f GB, Available: %.2f GB", 
        target_size / bytes_per_gb, free_bytes / bytes_per_gb))
    os.exit(1)
end

print("\27[1;33m!\27[0m Allocating 64 MB of RAM\n")
