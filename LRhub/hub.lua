...
while true do
	...
	print("\27[33m4\27[32m Debugging - Opens a debugging menu\27[0m")
	print("\n\27[33m5\27[32m Exit - Exits the program\27[0m\n")
	...
	if inp and inp > 0 and inp < 6 then
		if inp == 1 then
			os.execute("clear")
			print("\27[1mLRhub\27[0m\n\27[3mv1.0.0\27[0m\n\nSystem Information\n───────────────────────────\n")
		...
		if inp == 2 then
			...
			os.execute("cd " .. p .. "/testingtool && python3 -u main.py")
			break
		end
		if inp == 3 then
			os.execute("clear")
			...
			os.execute("cd " .. p .. "/KBotter && python3 -u main.py")
			break
		end
		if inp == 4 then
			os.execute("clear")
			...
			print("Get the latest updates at \27[30mhttps://github.com/Kaladoo2/LRhub\27[0m")
